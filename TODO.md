...
- TASK-500 [TODO]: Adds an "experiment analysis" mode. In this optional mode:
    ...
    - The `returned_1d` and `sub_buy_success` percentages are re-computed separately per `variation_id`. The app displays the difference in retention & monetization rates by variation.
